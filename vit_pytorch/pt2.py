...
class PyramidPoolingTransformer(nn.Module):
    def __init__(self,  *, loss_type, GPU_ID, img_size=224, patch_size=7, in_chans=3, num_classes=1000, embed_dims=[64, 128, 320, 512],
        ...
        self.patch_embed4 = PatchEmbed(img_size=img_size // 16, patch_size=1, in_chans=embed_dims[2],
