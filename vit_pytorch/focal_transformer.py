...
from vit_pytorch.face_losses import ArcMarginProduct, CosFace
...
class FocalTransformer(nn.Module):
    ...
    def __init__(self, *,
        ...
        if self.loss_type == 'None':
            ...
            if self.loss_type == 'ArcMarginProduct':
                self.loss = ArcMarginProduct(in_features=self.num_features, out_features=num_classes)
            elif self.loss_type == 'CosFace':
                self.loss = CosFace(in_features=self.num_features, out_features=num_classes, device_id=self.GPU_ID)
