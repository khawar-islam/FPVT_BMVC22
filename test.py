...
def parse_arguments(argv):
    ...
    parser.add_argument('--model', default='/home/cvpr/Documents/Backbone_VIT_Epoch_2_Batch_20000_Time_2021-01-12-16-48_checkpoint.pth', help='training set directory')
    parser.add_argument('--network', default='VIT',
                        help='training set directory')
    parser.add_argument('--target', default='lfw,calfw',
                        help='')
